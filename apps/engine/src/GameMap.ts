...
import { exhaustivnessCheck } from '@wing-racer/shared'
import * as poly2tri from 're-poly2tri'
import * as decomp from 'poly-decomp-es'

// Set Matter polygon resolver to poly-decomp library
...
export class GameMap {
  ...
  public static createGeometry(
    ...
    for (const body of bodies) {
      ...
      // Bodies without holes can be safely parsed through poly-decomp library
      if (bodyHoles.length === 0) {
        const matterBody = GameMap.createBody(body.points)
